...
**Açık (B50).** Çubuk sayısı yetmezse alınacak; yük yolu için ≥1.5 mm² kablo envanterde belirsiz (KBL003 karışık); Q1 için TO-220 yalıtım seti doğrulanmadı. 3D baskı kutuya geçilirse yalnız adım 1–5 değişir, elektrik adımları (6–13) aynı kalır.
