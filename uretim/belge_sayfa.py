...
<div class="no"><b>USB her ölçümde kullanılamaz.</b> Kart izole
<b>değil</b>: USB takılıyken kartın toprağı bilgisayarınızın toprağıdır.
Şebeke referanslı bir devre (izole olmayan SMPS'in birincil tarafı gibi)
ölçülecekse <b>USB takılı olmamalı</b> — o iş için pil + Wi-Fi ile
çalışın, yani 1. kip. Ayrıntısı
